...
function M.setup()
  ...
  theme.highlights = {
    ...
    ["@text.literal.markdown_inline"] = { bg = c.none, fg = c.blue },
    ...
    ["@text.warning"] = { fg = c.bg, bg = c.none },
    ["@text.danger"] = { fg = c.bg, bg = c.none },
